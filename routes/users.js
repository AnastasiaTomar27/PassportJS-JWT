...
const {userRegister, login, setup2FA, verify2FA, userProfile, renewToken, logout, terminateSession, seed, addProductToOrder, checkMyOrder, fetchUserByAdmin, generateInvoice, downloadInvoice, checkInvoice} = require('@controllersUsers');
